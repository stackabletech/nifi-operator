...
=== Access NiFi the web interface

You can the connection settings for the NiFi cluster via script or stackablectl.
...
with should return something like this:
...
Then connect to `https://<ip>:<port>/nifi` and you should the NiFi web interface.
