...
Kubernetes operator for Apache NiFi. Deploy and run NiFi clusters with the Stackable Data Platform (SDP).
...
```bash
helm install nifi-operator oci://oci.stackable.tech/sdp-charts/nifi-operator
```
...
- `oci://quay.io/stackable/sdp-charts/nifi-operator`
...
See the [documentation](https://docs.stackable.tech/home/stable/nifi/) for the full picture.

## Custom resources

This operator installs and manages its own CustomResourceDefinitions, so they are not part of this chart.
The resources it reconciles, and the configuration they accept, are described in the [documentation](https://docs.stackable.tech/home/stable/nifi/).Each CRD is also browsable on the [Stackable Hub](https://hub.stackable.tech/components/nifi), with its schema and the API versions served per SDP release.
## Links

- [Documentation](https://docs.stackable.tech/home/stable/nifi/)
- [Stackable Hub](https://hub.stackable.tech/)
- [Source](https://github.com/stackabletech/nifi-operator)
- [Report an issue](https://github.com/stackabletech/nifi-operator/issues)
- [Stackable Data Platform](https://stackable.tech/)

## License

[Open Software License version 3.0](https://github.com/stackabletech/nifi-operator/blob/main/LICENSE)
