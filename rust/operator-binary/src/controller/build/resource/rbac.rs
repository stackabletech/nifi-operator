...
///
/// Both RBAC resources are shared by the whole cluster rather than tied to a role or role group,
/// hence the cluster-shared recommended labels.
