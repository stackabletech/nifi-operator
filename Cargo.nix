...
rec {
  ...
  rootCrate = rec {
    packageId = "stackable-nifi-operator";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "windows-sys 0.52.0" = rec {
        ...
        resolvedDefaultFeatures = [ "Win32" "Win32_Foundation" "Win32_System" "Win32_System_Diagnostics" "Win32_System_Diagnostics_Debug" "Win32_System_Threading" "default" ];
      };
